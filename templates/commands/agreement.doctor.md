...
Read `specs/{{feature_id}}/tasks.md` to:
...
Append a new phase section at the end of tasks.md (before the "Dependencies & Execution Order" section if it exists).
...
**Contract reference**: specs/{{feature_id}}/contracts/
**Date**: {{date}}
...
Tasks written to: specs/{{feature_id}}/tasks.md (Phase N: Agreement Fixes)
...
- NEVER modify any file other than `specs/{{feature_id}}/tasks.md`.
